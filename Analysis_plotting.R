...
d_spec <- d_spec %>% 
  mutate_at(vars(p.tax.comp.grass, p.tax.comp.forb, p.tax.comp.tree, 
                 p.tax.comp.geophyt, p.tax.comp.legume, i.tax.comp.iszero),
            ~ as.factor(.))
...
varlabs <- c("p.tax.comp.grass" = expression("Com"["Tax" ]~"grass"),
             "p.tax.comp.grass1" = expression("Com"["Tax" ]~"grass"),
             "p.tax.comp.forb" = expression("Com"["Tax" ]~"forb"),
             "p.tax.comp.tree" = expression("Com"["Tax" ]~"tree"),
             "p.tax.comp.geophyt" = expression("Com"["Tax" ]~"geophyte"),
             "p.tax.comp.forb1" = expression("Com"["Tax" ]~"forb"),
             "p.tax.comp.tree1" = expression("Com"["Tax" ]~"tree"),
             "p.tax.comp.geophyt1" = expression("Com"["Tax" ]~"geophyte"),
             "p.tax.comp.legume" = expression("Com"["Tax" ]~"legume"),
             "p.tax.comp.legume1" = expression("Com"["Tax" ]~"legume"),
             "p.tax.comp.1" = expression("Com"["Tax" ]~"axis1"),
...
d_f_path_plotlevel_z <- d_comm %>% 
  select(plot, region, RW, HW, 
         ...
         p.tax.comp.1, p.tax.comp.2, p.tax.comp.3, p.tax.comp.grass, 
         p.tax.comp.forb, p.tax.comp.tree, p.tax.comp.geophyt, 
...
l_modlist_f_plot_1 <- list(
  lm(p.tax.comp.forb ~ ForMI + region, 
     data = d_f_path_plotlevel_z),
...
l_modlist_f_plot_sep_1 <- list(
  lm(p.tax.comp.forb ~ Inonat + Iharv + Idwcut + region, 
     data = d_f_path_plotlevel_z),
  lm(p.tax.comp.grass ~ Inonat + Iharv + Idwcut + region, 
     data = d_f_path_plotlevel_z),
  lm(p.tax.comp.geophyt ~ Inonat + Iharv + Idwcut + region, 
     data = d_f_path_plotlevel_z),
...
d_g_path_plotlevel_z <- d_comm %>% 
  select(plot, region, RW, HW, 
         ...
         p.tax.comp.grass, p.tax.comp.legume,
         p.fun.comp.sla, p.fun.comp.ldmc,
         p.tax.abund,
         p.fun.abund,
         p.tax.div.0, p.tax.div.1, p.tax.div.2,
...
update(mod_g_path_plot_sel, . ~ . - p.fun.div.1 - p.fun.div.0) %>% AIC
update(mod_g_path_plot_sel, . ~ . - p.fun.div.2- p.fun.div.1) %>% AIC
update(mod_g_path_plot_sel, . ~ . - p.fun.div.2- p.fun.div.0) %>% AIC

mod_g_path_plot_sel <- update(mod_g_path_plot_sel, . ~ . - p.fun.div.2 - p.fun.div.1)
performance::check_collinearity(mod_g_path_plot_sel)

update(mod_g_path_plot_sel, . ~ . - p.tax.div.1) %>% AIC
update(mod_g_path_plot_sel, . ~ . - p.tax.div.0) %>% AIC


mod_g_path_plot_sel <- update(mod_g_path_plot_sel, . ~ . - p.tax.div.1)
performance::check_collinearity(mod_g_path_plot_sel)

# SEM

l_modlist_g_plot_1 <- list(
  lm(p.tax.comp.grass ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  lm(p.tax.comp.legume ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  lm(p.tax.comp.2 ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  lm(p.tax.abund ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  lm(p.fun.abund ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  lm(p.tax.div.0 ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  lm(p.fun.div.0 ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  lm(i.fun.comp.1 ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  lm(i.tax.div.1 ~ LUI + region, 
     data = d_g_path_plotlevel_z),
  mod_g_path_plot_sel
)
...
update(mod_g_path_plot_sep_sel, . ~ . - p.tax.div.1) %>% AIC
update(mod_g_path_plot_sep_sel, . ~ . - p.tax.div.0) %>% AIC

mod_g_path_plot_sep_sel <- update(mod_g_path_plot_sep_sel, . ~ . - p.tax.div.1)
performance::check_collinearity(mod_g_path_plot_sep_sel)
...
l_modlist_g_plot_sep_1 <- list(
  lm(p.tax.comp.2 ~ M_std + F_std + G_std + region, 
     data = d_g_path_plotlevel_z),
  lm(p.tax.comp.grass ~ M_std + F_std + G_std + region, 
     data = d_g_path_plotlevel_z),
  lm(p.tax.comp.legume ~ M_std + F_std + G_std + region, 
     data = d_g_path_plotlevel_z),
  lm(p.tax.abund ~ M_std + F_std + G_std + region, 
     data = d_g_path_plotlevel_z),
  lm(p.fun.abund ~ M_std + F_std + G_std + region, 
     data = d_g_path_plotlevel_z),
  lm(p.tax.div.0 ~ M_std + F_std + G_std + region, 
     data = d_g_path_plotlevel_z),
  lm(p.fun.div.0 ~ M_std + F_std + G_std + region, 
     data = d_g_path_plotlevel_z),
  lm(i.fun.comp.1 ~ M_std + F_std + G_std + region, 
     data = d_g_path_plotlevel_z),
...
d_f_path_plotlevel_z <- d_spec %>% 
  select(plot, region, RW, HW, Host_Name_std,
         ...
         p.tax.comp.grass, p.tax.comp.forb,
         p.tax.comp.tree, p.tax.comp.geophyt,
...
l_modlist_f_sample_1 <- list(
  glmmTMB(p.tax.comp.forb ~ ForMI + region +
            (1 | plot), 
          family = binomial(),
          data = d_f_path_samplelevel_z),
  glmmTMB(p.tax.comp.tree ~ ForMI + region +
            (1 | plot), 
          family = binomial(),
          data = d_f_path_samplelevel_z),
  glmmTMB(p.tax.comp.geophyt ~ ForMI + region +
            (1 | plot), 
          family = binomial(),
          data = d_f_path_samplelevel_z),
...
d_semcoefs_f_sample <- d_semcoefs_f_sample %>% 
  ...
  mutate(response = ifelse(response == "i.tax.comp.iszero", "i.tax.comp.iszeroyes", response),
         response = ifelse(response == "p.tax.comp.grass", "p.tax.comp.grass1", response),
         response = ifelse(response == "p.tax.comp.forb", "p.tax.comp.forb1", response),
         response = ifelse(response == "p.tax.comp.tree", "p.tax.comp.tree1", response),
         response = ifelse(response == "p.tax.comp.geophyt", "p.tax.comp.geophyt1", response))
...
l_modlist_f_sample_sep_1 <- list(
  glmmTMB(p.tax.comp.forb ~ Inonat + Iharv + Idwcut + region +
            (1 | plot), 
          family = binomial(),
          data = d_f_path_samplelevel_z),
  glmmTMB(p.tax.comp.tree ~ Inonat + Iharv + Idwcut + region +
            (1 | plot), 
          family = binomial(),
          data = d_f_path_samplelevel_z),
...
update(mod_g_path_sample_sel, ". ~ . - i.tax.div.0 - i.tax.div.1") %>% AIC
update(mod_g_path_sample_sel, ". ~ . - i.tax.div.1 - i.tax.div.2") %>% AIC
update(mod_g_path_sample_sel, ". ~ . - i.tax.div.0 - i.tax.div.2") %>% AIC

mod_g_path_sample_sel <- update(mod_g_path_sample_sel, ". ~ . -  i.tax.div.1 - i.tax.div.2")
performance::check_collinearity(mod_g_path_sample_sel)
...
l_modlist_g_sample_1 <- list(
  glmmTMB(p.tax.comp.grass ~ LUI + region +
            (1 | plot), 
          family = binomial(),
          data = d_g_path_samplelevel_z),
  glmmTMB(p.tax.comp.legume ~ LUI + region +
            (1 | plot), 
          family = binomial(),
          data = d_g_path_samplelevel_z),
  ...
  glmmTMB(i.tax.abund ~ LUI + region + 
            (1 | plot) + (1 | Host_Name_std), 
          data = d_g_path_samplelevel_z),
  glmmTMB(i.tax.div.0 ~ LUI + region + 
            (1 | plot) + (1 | Host_Name_std), 
          data = d_g_path_samplelevel_z),
...
update(mod_g_path_sample_sep_sel, . ~ . - i.tax.div.0 - i.tax.div.2 ) %>% AIC
update(mod_g_path_sample_sep_sel, . ~ . - i.tax.div.1 - i.tax.div.2 ) %>% AIC
update(mod_g_path_sample_sep_sel, . ~ . - i.tax.div.0 - i.tax.div.2 ) %>% AIC

mod_g_path_sample_sep_sel <- update(mod_g_path_sample_sep_sel, . ~ . - i.tax.div.1 - i.tax.div.2)
performance::check_collinearity(mod_g_path_sample_sep_sel)
...
l_modlist_g_sample_sep_1 <- list(
  glmmTMB(p.tax.comp.grass ~ M_std + F_std + G_std + region +
            (1 | plot), 
          family = binomial(),
          data = d_g_path_samplelevel_z),
  glmmTMB(p.tax.comp.legume ~ M_std + F_std + G_std + region +
            (1 | plot),
          family = binomial(),
          data = d_g_path_samplelevel_z),
  ...
  glmmTMB(i.fun.comp.2 ~ M_std + F_std + G_std + region + i.tax.comp.iszero +
            (1 | plot) + (1 | Host_Name_std), 
          data = d_g_path_samplelevel_z),
  glmmTMB(i.fun.comp.3 ~ M_std + F_std + G_std + region + i.tax.comp.iszero +
            (1 | plot) + (1 | Host_Name_std), 
          data = d_g_path_samplelevel_z),
  glmmTMB(i.tax.abund ~ M_std + F_std + G_std + region + 
            (1 | plot) + (1 | Host_Name_std), 
          data = d_g_path_samplelevel_z),
  glmmTMB(i.tax.div.0 ~ M_std + F_std + G_std + region + 
            (1 | plot) + (1 | Host_Name_std), 
          data = d_g_path_samplelevel_z),
...
var_order[var_order == "p.tax.comp.grass"] <- "p.tax.comp.grass1"
var_order[var_order == "p.tax.comp.forb"] <- "p.tax.comp.forb1"
var_order[var_order == "p.tax.comp.tree"] <- "p.tax.comp.tree1"
var_order[var_order == "p.tax.comp.geophyt"] <- "p.tax.comp.geophyt1"
